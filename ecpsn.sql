...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-07-2015 a las 18:10:42
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mantiene la relacion de tags por snippet' AUTO_INCREMENT=152 ;
...
INSERT INTO `operational_status` (`ID`, `status_name`) VALUES
(3, 'Pendiente'),
(4, 'Aprobado'),
(5, 'Denegado');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Tabla que almacena los eventos del site que ha realizado un  /* comment truncated */ /*usuario*/' AUTO_INCREMENT=1363 ;
